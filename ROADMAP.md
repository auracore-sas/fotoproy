...
> **Estado al cerrar la sesión del 2026-09-11:** F4.1 y F4.2 ✅ (rama `feat/f4.1-share-links`, mergeada a `main`).
...
> **Siguiente bloque de trabajo**: **F4.3 pulido UX/offline** (estados vacíos, errores legibles, rendimiento de listas) o **F4.4 QA** (matriz iOS/Android + E2E). **F4.5–F4.7** después. Sigue bloqueado por terceros: **F2.4 despliegue** (credenciales Cloudflare R2 + dominio propio; hasta entonces el enlace usa la IP de LAN en dev).
