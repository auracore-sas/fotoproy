...
> **Siguiente bloque de trabajo**: **mejora de usabilidad de planos/mapas** (incluye un hueco crítico de offline: la imagen del plano no se cachea en el dispositivo) y luego **F4.4 QA** (matriz iOS/Android, E2E, org-scoping) + **F4.5 seguridad** (rate limiting en endpoints públicos, límites de subida, EXIF).
