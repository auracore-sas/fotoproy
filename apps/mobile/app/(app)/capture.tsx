...
import { colors, Button, fonts, radius } from '../../components/ui';
...
const styles = StyleSheet.create({
  ...
  permissionTitle: { fontFamily: fonts.display, fontSize: 20, color: colors.ink },
  permissionText: {
  ...
  flashButton: { minWidth: 68, paddingHorizontal: 8 },
  flashLabel: { fontSize: 10.5, letterSpacing: 0.6 },
  iconText: { color: '#FFF', fontSize: 16 },
  topTitle: { fontFamily: fonts.display, color: '#FFF', fontSize: 17 },
  modeBar: {
    position: 'absolute',
    top: 106,
    alignSelf: 'center',
  ...
  modeChip: { paddingHorizontal: 18, paddingVertical: 8, borderRadius: radius.pill },
  ...
  noticeChipText: { color: colors.accent, fontSize: 12, fontFamily: fonts.sansSemiBold },
  stampOverlay: {
    position: 'absolute',
    left: 16,
    right: 16,
  ...
  stampLine: { fontFamily: fonts.sansMedium, color: '#D7DEEC', fontSize: 13, marginTop: 2 },
  stampHint: { fontFamily: fonts.sans, color: colors.accent, fontSize: 12, marginTop: 7 },
  ratioControl: {
    position: 'absolute',
    left: 14,
    top: '38%',
  ...
  ratioText: { color: '#FFF', fontSize: 12.5, fontFamily: fonts.displayMedium },
  zoomControls: {
    position: 'absolute',
    right: 14,
    top: '38%',
  ...
  zoomButtonText: { color: '#FFF', fontSize: 22, fontFamily: fonts.sansMedium },
  shutterRow: {
    position: 'absolute',
    bottom: 44,
    alignSelf: 'center',
  ...
  recordButton: { borderColor: '#F87171', backgroundColor: 'rgba(220,38,38,0.35)' },
  recordDot: { width: 60, height: 60, borderRadius: 30, backgroundColor: colors.danger },
  recordStop: { width: 26, height: 26, borderRadius: 6, backgroundColor: '#FFF' },
  toast: {
    position: 'absolute',
    bottom: 136,
    alignSelf: 'center',
    backgroundColor: 'rgba(14,159,110,0.94)',
    borderRadius: radius.pill,
    paddingHorizontal: 18,
    paddingVertical: 9,
  },
  toastText: { fontFamily: fonts.sansSemiBold, color: '#FFFFFF', fontSize: 14 },
});
